<template>
  <div class="order-pay">
    ...
    <scan-code v-if="showPay" @close="closePayModel" :img="payImg"></scan-code>
    <model
      title="支付确认"
      btnType="3"
...
import ScanCode from "./ScanPayCode";
  ...
  methods: {
    ...
    getOrderDetail() {
      this.axios.get("/orders/" + this.orderId).then((res) => {
        ...
        this.addressInfo = `${item.receiverName} ${item.receiverMobile} ${item.receiverMobile} 
